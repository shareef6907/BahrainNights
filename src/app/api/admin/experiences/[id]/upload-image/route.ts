...
// POST - Upload new cover image for experience
export async function POST(
  ...
  try {
    ...
    if (file) {
      ...
      if (updateError) {
        console.error('Error updating experience image:', updateError);
    ...
    console.error('Error in POST /api/admin/experiences/[id]/upload-image:', error);
