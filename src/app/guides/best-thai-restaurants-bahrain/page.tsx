...
const restaurants = [
  ...
  {
    name: 'Thai Lounge',
    slug: 'thai-lounge-ritz-carlton',
    location: 'Ritz-Carlton, Seef',
    type: 'Fine Dining',
    rating: 5,
    price: 'BD 20-40 per person',
    cuisine: 'Thai & Asian Fusion',
    description: 'Located within the luxurious Ritz-Carlton Bahrain, Thai Lounge offers Asian/Thai cuisine with a contemporary twist. During the day, enjoy light snacks and refreshing drinks; evenings bring DJ entertainment and a vibrant atmosphere. The menu blends authentic Thai flavors with modern techniques, from street food classics to elegantly reimagined specialties.',
    specialties: ['Thai street food classics', 'Premium Thai curries', 'Fresh seafood', 'Signature cocktails', 'Asian desserts'],
    atmosphere: 'Chic lounge atmosphere with evening DJ entertainment',
    hours: 'Mon-Wed & Sat-Sun 4PM-12AM, Thu-Fri 10AM-1AM',
    reservation: 'Recommended for evenings',
    bestFor: 'Evening drinks, casual Thai dining, DJ nights, hotel guests',
    mustTry: 'Signature Thai dishes, cocktails, Asian-inspired small plates',
  },
  {
    name: 'Krua Thai',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Thai Lounge at the Ritz-Carlton offers a chic setting with DJ evenings for a vibrant date night. Talay Thai in Adliya provides intimate fine dining with exceptional food. Monsoon at InterContinental Regency combines sophisticated atmosphere with premium Thai cuisine.',
  },
  {
