...
export const metadata: Metadata = {
  ...
  description: 'Find Dior boutiques in Bahrain at Marassi Galleria and Moda Mall. Complete guide to Dior stores with fashion, beauty, store hours, directions & shopping tips.',
  keywords: 'Dior Bahrain, Dior store Bahrain, where to buy Dior Bahrain, Dior Moda Mall, Dior Marassi Galleria, Dior beauty Bahrain, Dior bags Bahrain',
  openGraph: {
    title: 'Dior Bahrain - Store Locations & Shopping Guide 2026',
    description: 'Find Dior boutiques in Bahrain at Marassi Galleria and Moda Mall. Complete guide with store hours, directions & shopping tips.',
    type: 'article',
    locale: 'en_US',
...
const storeLocations = [
  ...
  },
  {
    ...
    hours: 'Sun-Wed: 10:00 AM - 10:00 PM, Thu-Sat: 10:00 AM - 12:00 AM',
    products: ['Ready-to-Wear', 'Handbags', 'Accessories', 'Shoes', 'Fine Jewelry', 'Watches', 'Fragrances', 'Beauty'],
    features: ['Full boutique', 'World Trade Centre location', 'Premium mall', 'Complete collection'],
