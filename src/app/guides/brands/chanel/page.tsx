...
const storeLocations = [
  ...
  {
    name: 'Chanel Fragrance & Beauty Boutique - The Avenues',
    mall: 'The Avenues Bahrain',
    address: 'The Avenues Mall, Bahrain Bay, Manama',
    floor: 'Ground Floor',
    hours: 'Sun-Wed: 10:00 AM - 10:00 PM, Thu-Sat: 10:00 AM - 12:00 AM',
    products: ['Fragrance', 'Beauty', 'Skincare', 'Makeup', 'Eyewear'],
    features: ['Fragrance & Beauty Boutique only', 'Bahrain Bay waterfront', 'No fashion/handbags - visit Marassi for full collection'],
