...
const restaurants = [
  ...
  },
  {
    ...
    description: 'Palace-style décor with intricate wood screens and jewel-toned fabrics. Live santoor player creates an authentic royal Indian atmosphere.',
    specialties: ['Grilled seafood', 'Kebabs', 'Aromatic curries', 'The Great Indian Thali'],
    atmosphere: 'Luxury hotel, elegant palace theme',
    hours: 'Lunch and dinner daily',
    reservation: 'Recommended',
    bestFor: 'Special occasions, romantic dinners, business entertaining',
    mustTry: 'The Great Indian Thali, Grilled Seafood Platter, Kebab selection',
  },
  {
    name: 'Charcoal Grill',
    location: 'Juffair',
...
const restaurantsByCategory = [
  { category: 'Fine Dining', picks: ['Rasoi by Vineet', 'Silk\'s', 'Nirvana'] },
