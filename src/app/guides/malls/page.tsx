...
const malls = [
  {
    ...
    size: '158,000 sqm',
    stores: '350+ stores',
    description: 'Bahrain\'s largest and most popular mall with world-class shopping, dining, and entertainment including Wahooo! Waterpark, Magic Planet, and 20-screen Cineco cinema.',
    highlights: ['Wahooo! Waterpark', 'Magic Planet', '20-screen Cineco', 'Carrefour Hypermarket', 'Saks Fifth Avenue'],
    brands: ['Zara', 'H&M', 'Marks & Spencer', 'Apple', 'Nike', 'Sephora', 'Virgin Megastore'],
    dining: 'Food court + 60+ restaurants',
  ...
  {
    name: 'Seef Mall (3 Locations)',
    location: 'Seef District, Muharraq, Isa Town',
    type: 'Premium Mall',
    rating: 5,
    size: '135,000 sqm (Seef District)',
    stores: '250+ stores',
    description: 'Bahrain\'s first authentic mall (opened 1997) and premier family shopping destination. Now with 3 locations across the Kingdom, each featuring Magic Island entertainment and cinemas.',
    highlights: ['Magic Island', 'Cineco Cinema (Seef)', 'Novo Cinemas (Muharraq)', 'Jumpoline (Isa Town)', 'Fraser Suites Hotel'],
    brands: ['Massimo Dutti', 'Mango', 'Next', 'Marks & Spencer', 'Pottery Barn', 'Bath & Body Works'],
    dining: 'Food court + restaurants',
    parking: '5,000+ spaces (free)',
    hours: 'Sat-Wed 10AM-10PM, Thu-Fri 10AM-12AM',
    bestFor: 'Family shopping, mid-range brands, entertainment',
  ...
  },
  {
    ...
    type: 'Lifestyle Mall',
    rating: 5,
    size: '273,000 sqm total (38,000 sqm retail)',
    stores: '130+ stores',
    description: 'Premium waterfront lifestyle destination along 1.5km seafront with stunning Bahrain Bay views. Single-floor design with outdoor promenade, Below Zero ice rink, and water taxi service.',
    highlights: ['Below Zero Ice Rink', '1.5km Bahrain Bay waterfront', 'VOX Cinemas', 'Outdoor promenade', 'Water taxi service'],
    brands: ['Christian Dior', 'Swarovski', 'H&M', 'Cheesecake Factory', 'Shake Shack'],
    dining: 'Premium restaurants + waterfront cafes (50% of outlets)',
    parking: '1,400+ spaces',
    hours: 'Sat-Wed 10AM-10PM, Thu-Fri 10AM-12AM',
    bestFor: 'Waterfront dining, ice skating, evening strolls',
  ...
  },
  {
    ...
    size: '45,000 sqm',
    stores: '90+ stores',
    description: 'Bahrain\'s premier luxury shopping destination housed in the iconic World Trade Centre with its famous wind turbines. Features the Kingdom\'s largest portfolio of high-end fashion and jewelry brands.',
    highlights: ['Iconic BWTC location', 'Luxury fashion', '50+ jewelry brands', 'Premium dining'],
  ...
  {
    name: 'Dana Mall',
    location: 'Seef District / Sanabis',
    type: 'Community Mall',
    rating: 4,
    size: '65,000 sqm',
    stores: '100+ stores',
    description: 'One of Bahrain\'s first malls (opened 2002) featuring Lulu Hypermarket as anchor store (the first LuLu in Bahrain) and EPIX Cinemas with 10 screens.',
    highlights: ['Lulu Hypermarket', 'EPIX Cinemas (10 screens)', 'LuLu Group HQ', 'Food court'],
    brands: ['Max', 'Splash', 'Lifestyle', 'Shoe Mart', 'various retail'],
    dining: 'Food court + restaurants',
    parking: '1,800 spaces (free)',
    hours: 'Sat-Wed 9AM-10PM, Thu-Fri 9AM-11PM',
    bestFor: 'Grocery shopping, cinema, local community',
    href: null,
  },
  {
    name: 'Bahrain Mall',
  ...
  },
  {
    ...
    size: '35,000 sqm',
    stores: '80+ stores',
    description: 'Convenient neighborhood mall in Juffair with everyday shopping, dining, and services. Popular with expat community.',
  ...
  },
  {
    ...
    size: '45,000 sqm',
    stores: '100+ stores',
    description: 'Modern shopping destination in Riffa with a mix of retail, dining, and entertainment options serving the southern governorate.',
    highlights: ['Modern design', 'Supermarket', 'Fashion brands', 'Kids entertainment'],
    brands: ['Centrepoint', 'Max', 'Lifestyle', 'various retail'],
    dining: 'Food court + restaurants',
    parking: '2,000+ spaces (free)',
    hours: 'Sat-Wed 10AM-10PM, Thu-Fri 10AM-11PM',
    bestFor: 'Riffa residents, family shopping',
    href: null,
  },
  {
    ...
    size: '25,000 sqm',
    stores: '50+ stores',
    description: 'Convenient neighborhood mall serving Saar and surrounding residential areas with everyday shopping needs.',
    highlights: ['Supermarket', 'Local shops', 'Restaurants', 'Services'],
    brands: 'Various local and international retailers',
    dining: 'Cafes + restaurants',
    parking: '500+ spaces (free)',
    hours: 'Sat-Wed 9AM-10PM, Thu-Fri 9AM-11PM',
    bestFor: 'Saar residents, convenience shopping',
    href: null,
  },
  {
    name: 'Dragon City',
    ...
    size: '70,000 sqm',
    stores: '800+ shops',
    description: 'Bahrain\'s largest wholesale market featuring Chinese goods at bargain prices — electronics, fashion, home goods, and more. Popular for bulk buying.',
...
const shoppingTips = [
  {
    title: 'Sale Seasons',
    content: 'Major sales happen during Shop Bahrain (Jan-Feb), Ramadan, and year-end. Black Friday and Cyber Monday sales are increasingly popular.',
  },
  {
    title: 'Tax Free',
    content: 'Bahrain has no sales tax (VAT-free), making it great value compared to UAE\'s 5%. What you see is what you pay.',
  },
  {
    title: 'Best Days',
    content: 'Weekday mornings are quietest. Friday afternoons and Saturday evenings are busiest. Ramadan hours differ (often 9PM-2AM).',
  },
  {
    title: 'Gold Shopping',
    content: 'For gold jewelry, visit Gold City in Manama Souq for traditional shopping with negotiation. Malls have fixed prices but more variety.',
  },
];

const mallsByCategory = [
  { category: 'Luxury Shopping', malls: ['Marassi Galleria', 'Moda Mall', 'The Avenues'] },
  { category: 'Family Entertainment', malls: ['City Centre', 'Seef Mall', 'Marassi Galleria'] },
  { category: 'Budget Shopping', malls: ['Dragon City', 'Bahrain Mall', 'Dana Mall'] },
  { category: 'Beachfront/Waterfront', malls: ['Marassi Galleria', 'The Avenues', 'Souq Al Baraha'] },
];
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
            {[
              { label: 'Major Malls', value: '12+', icon: ShoppingBag },
              { label: 'Total Stores', value: '2,500+', icon: Star },
            ...
            {[
              {
                ...
                a: 'City Centre Bahrain is the largest mall with 158,000 sqm of retail space, 350+ stores, and entertainment including Wahooo! Waterpark, Magic Planet, and a 20-screen Cineco cinema.',
              },
              {
                q: 'Which mall has the best luxury brands in Bahrain?',
                a: 'Moda Mall (inside Bahrain World Trade Centre) and Marassi Galleria are the top destinations for luxury brands including Louis Vuitton, Gucci, Dior, Rolex, and Cartier.',
              },
              {
              ...
              },
              {
                ...
                a: 'Most malls open 10AM-10PM Saturday-Wednesday, and 10AM-12AM on Thursday-Friday. Moda Mall opens at 2PM on Fridays. Hypermarkets often open earlier (9AM).',
              },
            ].map((faq, i) => (
