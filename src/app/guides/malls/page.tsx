...
const malls = [
  {
    ...
    size: '185,000 sqm',
    stores: '340+ stores',
    description: 'Bahrain\'s largest and most popular mall with world-class shopping, dining, and entertainment including Wahooo! Waterpark and Magic Planet.',
    highlights: ['Wahooo! Waterpark', 'Magic Planet', 'VOX Cinemas', 'Carrefour Hypermarket', 'IKEA Connected'],
  ...
  },
  {
    ...
    size: '170,000 sqm',
    stores: '200+ stores',
    description: 'Bahrain\'s newest premium lifestyle destination with stunning architecture, luxury brands, and waterfront dining along Bahrain Bay.',
    highlights: ['Bahrain Bay views', 'Luxury brands', 'Outdoor promenade', 'Cinema complex'],
  ...
  },
  {
    ...
    size: '60,000 sqm',
    stores: '120+ stores',
    description: 'Popular family-friendly mall with good value shopping, excellent entertainment options including bowling and ice skating.',
    highlights: ['Ice skating rink', 'Bowling alley', 'Fun Zone', 'LuLu Hypermarket'],
...
const mallsByCategory = [
  ...
  { category: 'Family Entertainment', malls: ['City Centre', 'Bahrain Mall'] },
