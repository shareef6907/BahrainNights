...
const topRestaurants = [
  ...
  },
  {
    ...
    price: '$$$',
    rating: 4.8,
    description: 'Award-winning Italian cuisine in a contemporary setting. One of the 50 Best Restaurants in MENA. Known for fresh pasta and Mediterranean dishes.',
    mustTry: ['Truffle pasta', 'Fresh seafood', 'Tiramisu'],
  ...
  },
  {
    ...
    price: '$$$',
    rating: 4.8,
    description: 'Rooftop restaurant at The Merchant House boutique hotel with stunning views, British garden-inspired terrace.',
    mustTry: ['Mediterranean mezze', 'Afternoon tea', 'Cocktails'],
    atmosphere: 'Elegant, intimate, rooftop terrace',
  ...
  },
  {
    ...
    price: '$$',
    rating: 4.7,
    description: 'Authentic Persian fine dining inspired by Persia\'s royal palace. Loved by locals for over 20 years.',
    mustTry: ['Joojeh kebab', 'Ghormeh sabzi', 'Tahdig rice'],
    atmosphere: 'Elegant, traditional Persian decor',
    reservations: 'Recommended',
  },
  {
    name: 'Bushido',
...
const cuisineGuide = [
  ...
  },
  {
    ...
    topPicks: ['CUT', 'Bushido', 'Indigo Terrace', 'Masso'],
            ...
            {[
              {
                ...
                a: 'The top fine dining restaurants in Bahrain include CUT by Wolfgang Puck at Four Seasons, Bushido at The Ritz-Carlton, and Masso at Palmyard Hotel. These offer exceptional food, service, and ambiance.',
              },
              {
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'The top fine dining restaurants in Bahrain include CUT by Wolfgang Puck at Four Seasons, Bushido at The Ritz-Carlton, and Masso at Palmyard Hotel.',
                },
              },
              {
                '@type': 'Question',
