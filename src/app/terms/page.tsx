  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* Section 1: About BahrainNights */}
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-amber-500/20 rounded-lg">
              <MapPin className="w-6 h-6 text-amber-400" />
            </div>
            <h2 className="text-2xl font-bold text-white">1. About BahrainNights</h2>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="pl-12 space-y-4 text-gray-300">
            <h3 className="text-lg font-semibold text-white">2.1 Public Users</h3>
            ...
            <h3 className="text-lg font-semibold text-white mt-6">2.2 Venue Owners</h3>
            <ul className="list-disc pl-6 space-y-2">
        ...
        {/* Section 3: Content Guidelines - IMPORTANT */}
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-red-500/20 rounded-lg">
              <AlertTriangle className="w-6 h-6 text-red-400" />
            </div>
            <h2 className="text-2xl font-bold text-white">3. Content Guidelines</h2>
          </div>
          ...
          <div className="pl-12 space-y-6 text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">3.2 Dress Code in Photos</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
        ...
        {/* Section 4: Photo & Media Guidelines */}
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-purple-500/20 rounded-lg">
              <Camera className="w-6 h-6 text-purple-400" />
            </div>
            <h2 className="text-2xl font-bold text-white">4. Photo & Media Guidelines</h2>
          </div>
          <div className="pl-12 space-y-4 text-gray-300">
            <p>
        ...
        {/* Section 5: Venue Listing Terms */}
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-green-500/20 rounded-lg">
              <Shield className="w-6 h-6 text-green-400" />
            </div>
            <h2 className="text-2xl font-bold text-white">5. Venue Listing Terms</h2>
          </div>
          <div className="pl-12 space-y-4 text-gray-300">
            ...
            <h3 className="text-lg font-semibold text-white mt-6">5.2 Premium Advertising</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-white mt-6">5.3 Approval Process</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-white mt-6">5.4 Profile Changes</h3>
            <ul className="list-disc pl-6 space-y-2">
        ...
        {/* Section 6: Event Listing Terms */}
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-pink-500/20 rounded-lg">
              <Scale className="w-6 h-6 text-pink-400" />
            </div>
            <h2 className="text-2xl font-bold text-white">6. Event Listing Terms</h2>
          </div>
          <div className="pl-12 space-y-4 text-gray-300">
            <ul className="list-disc pl-6 space-y-2">
