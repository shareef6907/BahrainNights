  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Add New Sponsor</h1>
          <p className="text-gray-400 mt-1">Create a new sponsor entry</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-6">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
            <LogoUploader
              entityType="sponsor"
              sponsorSlug={generateSlug(formData.name) || 'new-sponsor'}
              currentLogo={logoUrl}
