...
export default function RegionalTrailersAdminPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      // Fetch featured trailers (uses same API as blog)
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-2xl font-bold">Regional Page Trailers</h1>
            </div>
            <p className="text-gray-400">Manage trailers shown on the Regional page hero section</p>
          </div>
          <Link
            href="/admin"
          ...
          <>
            ...
            <div className="bg-gray-900 rounded-xl p-6 mb-8 border border-gray-800">
              <h2 className="font-bold mb-4 flex items-center gap-2">
                ...
                Add Trailer to Regional Hero
              </h2>
              <div className="flex gap-4">
                <select
                  value={selectedMovie}
                  onChange={(e) => setSelectedMovie(e.target.value)}
                  className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-yellow-500 focus:outline-none"
                >
                ...
                <button
                  ...
                  className="bg-yellow-500 text-black px-6 py-3 rounded-lg font-medium hover:bg-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
                >
                  <Plus size={18} />
                  Add
                </button>
            ...
            <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-800">
              <div className="p-4 border-b border-gray-800 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">First trailer plays first on the Regional page</p>
                </div>
              </div>
                ...
                <div className="divide-y divide-gray-800">
                  {featuredTrailers.map((trailer, index) => (
                    ...
                    >
                      ...
                      {/* Order Number */}
                      <div className="w-10 h-10 bg-yellow-500 text-black rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0">
                        {index + 1}
                      </div>
            ...
            <div className="mt-6 p-4 bg-gray-900/50 rounded-xl border border-gray-800">
              ...
              <ul className="text-sm text-gray-500 space-y-1">
                <li>
                  <span className="text-yellow-400">1.</span> Select movies from the dropdown to add them as featured trailers
                </li>
                <li>
                  <span className="text-yellow-400">2.</span> Use the arrows to reorder - first trailer plays first
                </li>
                <li>
                  <span className="text-yellow-400">3.</span> Use the eye icon to temporarily hide a trailer without removing it
                </li>
                <li>
                  <span className="text-yellow-400">4.</span> Trailers auto-advance every 25 seconds on the Regional page
                </li>
              </ul>
            </div>
          </>
