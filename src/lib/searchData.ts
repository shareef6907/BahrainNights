...
export const offersData: SearchItem[] = [
  ...
  },
  {
    id: 'offer-15',
    type: 'offer',
    title: 'Al Dar Islands Boat Trip Deal',
    slug: 'al-dar-islands-group',
    description: 'Book 4 get 1 free on island boat trips',
    image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800',
    url: '/offers/al-dar-islands-group',
    venue: 'Al Dar Islands',
    area: 'Sitra',
    category: 'Tours',
    tags: ['island', 'boat', 'group', 'beach', 'adventure'],
  },
  {
    id: 'offer-16',
    type: 'offer',
