      ...
      <div className="hidden lg:flex lg:w-2/5 relative">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 w-full">
          ...
          <Link href="/" className="inline-flex items-center gap-2 mb-8">
            <span className="text-3xl font-black bg-gradient-to-r from-yellow-500 via-amber-400 to-yellow-600 bg-clip-text text-transparent">
              BahrainNights
            </span>
        ...
        >
          ...
          <div className="lg:hidden text-center mb-8">
            <Link href="/" className="inline-flex flex-col items-center gap-2">
              <span className="text-2xl font-black bg-gradient-to-r from-yellow-500 via-amber-400 to-yellow-600 bg-clip-text text-transparent">
                BahrainNights
              </span>
              <span className="flex text-xs text-yellow-400 items-center gap-1">
                <Sparkles className="w-3 h-3" />
