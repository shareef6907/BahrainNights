        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 pt-20 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative aspect-[3/4] max-w-md mx-auto lg:mx-0 rounded-2xl overflow-hidden shadow-2xl">
              ...
              {/* Featured Badge */}
              {artist.is_featured && (
                <div className="absolute top-4 left-4 px-4 py-1.5 bg-amber-500 text-white text-sm font-semibold rounded-full shadow-lg">
                  Featured Artist
                </div>
              )}
            </div>
            ...
            <div>
              {/* Category Badge */}
              <span className={`inline-block px-4 py-1.5 ${CATEGORY_COLORS[artist.category]} text-white text-sm font-medium rounded-full mb-4`}>
                {displayCategory}
              </span>
              ...
              {artist.bio && (
                <div className="prose prose-invert prose-lg max-w-none mb-8">
                  <p className="text-gray-400 whitespace-pre-wrap">{artist.bio}</p>
                </div>
              )}
              ...
              <button
                ...
                className="w-full md:w-auto px-10 py-4 bg-amber-500 hover:bg-amber-600 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-amber-500/30 text-lg"
              >
                Book This Artist
              </button>
            </div>
