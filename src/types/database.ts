    ...
    Tables: {
      ...
      artists: {
        Row: {
          ...
          updated_at: string;
          status: 'pending' | 'approved' | 'rejected' | 'suspended';
          tier: 'vibes' | 'bahrainnights_exclusive';
          stage_name: string;
...
export type ArtistBookingRequest = Database['public']['Tables']['artist_booking_requests']['Row'];
export type ArtistBookingRequestInsert = Database['public']['Tables']['artist_booking_requests']['Insert'];
export type ArtistBookingRequestUpdate = Database['public']['Tables']['artist_booking_requests']['Update'];

// Artist category type
export type ArtistCategory = 'dj' | 'vocalist' | 'instrumentalist' | 'band' | 'fire_show' | 'performer' | 'kids_entertainment' | 'magician';
export type ArtistStatus = 'pending' | 'approved' | 'rejected' | 'suspended';
export type ArtistTier = 'vibes' | 'bahrainnights_exclusive';
